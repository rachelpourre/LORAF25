...
class QLoRALinear(Linear4Bit):
    def __init__(
        ...
        self.lora_A = torch.nn.Parameter(torch.zeros(in_features, lora_dim, dtype=torch.float32))
        self.lora_B = torch.nn.Parameter(torch.zeros(lora_dim, out_features, dtype=torch.float32))
